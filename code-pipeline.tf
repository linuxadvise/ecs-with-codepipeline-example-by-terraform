locals {
  github_token = "2cf1f0bd56b1a2a04a0066144b4b9bd2bbaa1833" #example : fill your information

  github_owner  = "linuxadvise"
  github_repo   = "ecs-nodejs-app-example"
  github_branch = "master"
}

resource "aws_s3_bucket" "pipeline-piyush-713812" {
...
resource "aws_codepipeline" "this" {
  name     = "${var.service_name}-codepipeline-bucket"
